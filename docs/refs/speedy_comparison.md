...
| Convection | **Simplified Betts–Miller (Frierson 2007)** — whole-column moist adjustment, relaxes q→rhbm·q_sat with **rhbm≈0.8**, deep+shallow branches, enthalpy-conserving | Simplified **mass-flux** (Kucharski/Tiedtke-like), SMSE closure → intrinsic compensating environmental subsidence | Betts–Miller-style, but **pairwise adjacent-layer** (not whole-column) and its buoyancy trigger goes **dormant at equilibrium** → no free-trop drying (§23) |
